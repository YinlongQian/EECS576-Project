...
#Running 576 Project
After installing the package as explained above, navagiate to the embedding directory. You can then generate corresponding embeddings by calling `DATASET_embedding.py` with appropriate command line arguments. 
