...
if __name__ == '__main__':
    ...
    if time_interval == 'monthly':
        ...
        with open('/z/pujat/576/data/amazon_food/amazon_food_monthly_dir.pkl',
                  'rb') as file:
            graphs = pickle.load(file)

        save_suffix = "amazon_food_1_month_dir"
        

    #TODO: Need to adjust path name
    if time_interval == 'weekly':

        with open('/z/pujat/576/data/amazon_food/amazon_food_weekly_dir.pkl',
                  'rb') as file:
            graphs = pickle.load(file)

        save_suffix = "amazon_food_1_weekly_dir"
        

    elif time_interval == 'equal_monthly': 
        with open('/z/pujat/576/data/amazon_food/amazon_food_equal_monthly_dir.pkl'
                  'rb') as file:
            graphs = pickle.load(file)

        save_suffix = "amazon_food_equal_monthly_dir"
        
    elif time_interval == 'equal_weekly': 
        with open('/z/pujat/576/data/amazon_food/amazon_food_equal_weekly_dir.pkl'
                  'rb') as f :
            graphs = pickle.load(fil 
        save_suffix = "amazon_food_equal_weekly_dir"
    else:
    ...
    #NOTE: we are only considering the last 20 snapshots 
    # for amazon. That's why I do the cut here!
