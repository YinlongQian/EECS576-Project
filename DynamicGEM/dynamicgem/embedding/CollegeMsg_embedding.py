...
if __name__ == '__main__':
    ...
    if is_agg: 
        ...
        if time_interval == 'month':
            ...
            if is_dir: 
                with open('/z/pujat/576/data/CollegeMsg/Graphs_Month_MSG/msg_1_month_agg_dir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_1_month_agg_dir"
            
            else: 
                with open('/z/pujat/576/data/CollegeMsg/Graphs_Month_MSG/msg_1_month_agg_undir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_1_month_agg_undir"

        #TODO: Need to adjust path name
        if time_interval == 'day':

            if is_dir: 
                with open('/z/pujat/576/data/CollegeMsg/msg_1_day_agg_dir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_1_day_agg_dir"
            
            else: 
                with open('/z/pujat/576/data/CollegeMsg/msg_1_day_agg_undir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_1_day_agg_undir"

        elif time_interval == 'week': 
            if is_dir: 
                with open('/z/pujat/576/data/CollegeMsg/Graphs_Week_MSG/msg_1_week_agg_dir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_1_week_agg_dir"
            
            else: 
                with open('/z/pujat/576/data/CollegeMsg/Graphs_Week_MSG/msg_1_week_agg_undir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_1_week_agg_undir"
        else:
        ...
        if time_interval == 'month':
            ...
            if is_dir: 
                with open('/z/pujat/576/data/CollegeMsg/Graphs_Month_MSG/msg_1_month_dir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_1_month_dir"
            
            else: 
                with open('/z/pujat/576/data/CollegeMsg/Graphs_Month_MSG/msg_1_month_undir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_1_month_undir"
        #TODO: Fix file paths 
        if time_interval == 'day':

            if is_dir: 
                with open('/z/pujat/576/data/CollegeMsg/msg_1_day_dir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_1_day_dir"
            
            else: 
                with open('/z/pujat/576/data/CollegeMsg/msg_1_day_undir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_1_day_undir"

        elif time_interval == 'week': 
            if is_dir: 
                with open('/z/pujat/576/data/CollegeMsg/Graphs_Week_MSG/msg_1_week_dir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_1_week_dir"
            
            else: 
                with open('/z/pujat/576/data/CollegeMsg/Graphs_Week_MSG/msg_1_week_undir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "msg_1_week_undir"
        
        elif time_interval == 'equal':
            if is_dir: 
                with open('/z/pujat/576/data/CollegeMsg/Graphs_Equal_Edge_MSG/msg_equal_edge_dir.pkl',
                          'rb') as file:
                    graphs = pickle.load(file)

                save_suffix = "CollegeMsg_equal_dir"
